...
# This has the advantage in actual hardware deployment where Predictor Agent is most
# likely
# to be deployed on limited computing resource compared to Trainer Agent which may be
# more resourceful
# However, it is important to note that - the predictor and trainer has not been
# synchronized
...
class Trainer(AgentMET4FOF):
    def init_parameters(self, ml_model=HoeffdingTreeClassifier()):
        self.ml_model = ml_model
